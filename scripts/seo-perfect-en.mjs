...
const replacements = [
	...
	// trial / Fortnite lexicon → Dead by Daylight
	...
	['Player, killer, and generators', 'Survivor, killer, and generator'],
	...
	['generators, generators, and killers', 'generators, hook locations, and killers'],
	...
	['enemy teams, killers, and high-value objectives', 'enemy teams, killers, and high-value objectives'],
	[
	...
	['loot, vehicles, and chests', 'loot, killers, and generators'],
	...
	['full trial loop', 'full trial loop'],
