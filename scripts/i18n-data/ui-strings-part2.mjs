...
export const uiStringsPart2 = {
	ar: {
		...
		reviews: { title: 'ماذا يقول اللاعبون', subtitle: 'آراء حديثة من مشتري DBD Cheats', outOf: 'من 5', countLabel: 'مراجعات' },
	...
	ja: {
		...
		reviews: { title: 'プレイヤーの声', subtitle: 'DBD Cheats購入者からの最近のフィードバック', outOf: '/5', countLabel: '件のレビュー' },
	...
	ko: {
		...
		reviews: { title: '플레이어 후기', subtitle: 'DBD Cheats 구매자 최근 피드백', outOf: '/5', countLabel: '리뷰' },
	...
	zh: {
		...
		reviews: { title: '玩家评价', subtitle: 'DBD Cheats 买家近期反馈', outOf: '/5', countLabel: '条评价' },
	...
	hi: {
		...
		reviews: { title: 'खिलाड़ी क्या कहते हैं', subtitle: 'DBD Cheats खरीदारों की हाल की प्रतिक्रिया', outOf: '/5', countLabel: 'समीक्षाएँ' },
	...
	id: {
		...
		reviews: { title: 'Apa kata pemain', subtitle: 'Umpan balik terbaru dari pembeli DBD Cheats', outOf: 'dari 5', countLabel: 'ulasan' },
	...
	th: {
		...
		reviews: { title: 'ผู้เล่นพูดว่าอย่างไร', subtitle: 'ความคิดเห็นล่าสุดจากผู้ซื้อ DBD Cheats', outOf: 'จาก 5', countLabel: 'รีวิว' },
	...
	vi: {
		...
		reviews: { title: 'Người chơi nói gì', subtitle: 'Phản hồi gần đây từ người mua DBD Cheats', outOf: '/5', countLabel: 'đánh giá' },
	...
	uk: {
		...
		reviews: { title: 'Що кажуть гравці', subtitle: 'Останні відгуки покупців DBD Cheats', outOf: 'з 5', countLabel: 'відгуків' },
	...
	cs: {
		...
		reviews: { title: 'Co říkají hráči', subtitle: 'Nedávná zpětná vazba od kupujících DBD Cheats', outOf: 'z 5', countLabel: 'recenzí' },
	...
	ro: {
		...
		reviews: { title: 'Ce spun jucătorii', subtitle: 'Feedback recent de la cumpărătorii DBD Cheats', outOf: 'din 5', countLabel: 'recenzii' },
	...
	sv: {
		...
		reviews: { title: 'Vad spelare säger', subtitle: 'Senaste feedback från DBD Cheats-köpare', outOf: 'av 5', countLabel: 'recensioner' },
