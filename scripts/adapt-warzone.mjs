...
const REPLACEMENTS = [
	...
	['fortnite hacks', 'warzone hacks'],
	['fortnite cheats', 'warzone cheats'],
	['trial map, Zero Build, and live servers', 'trial map, Urzikstan, and Rebirth Island'],
	['trial map, Zero Build and live servers', 'trial map, Urzikstan and Rebirth Island'],
	['trial map, Zero Build et lobbies compétitifs', 'trial map, Urzikstan et Rebirth Island'],
	['trial map, Zero Build e lobbies competitivi', 'trial map, Urzikstan e Rebirth Island'],
	['trial map, Zero Build und Competitive-Lobbys', 'trial map, Urzikstan und Rebirth Island'],
	...
	['loot chests', 'fresh generators'],
	['loot chest', 'loadout drop'],
	['trial map', 'trial map'],
	['survival-game-island', 'al-mazrah'],
	['supply drop', 'UAV'],
	['species', 'species'],
	['operators', 'operators'],
