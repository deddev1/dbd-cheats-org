...
const sources = [
	{
		...
		metaDescription:
			'Learn how Dead by Daylight patch notes change killer builds, growth economy, and maps. What to do after Easy Anti-Cheat and major updates in 2026.',
		h1: 'How to Read Dead by Daylight Patch Notes Without Guessing',
		intro:
			'When Behaviour Interactive drops a patch, most players skim the headline and queue anyway. That is how you walk into MacMillan Estate with the wrong ammo and a gun that just lost its damage output. Here is a calmer way to read Dead by Daylight patch notes so your next trial still makes sense.',
		keywords: [
			'the dbd patch notes',
			'dbd major update',
			'eac patch',
		...
		sections: [
			{
				...
				paragraphs: [
					`Official notes live on ${EXT.dbd}. Treat that page as the source of truth — Discord rumors and streamer hot takes come second. Ask three plain questions for every bullet: Does this change how adult killers chase? Does this change what carcasses are worth chaseing? Does this change which nest or map I should play tonight?`,
					...
					`If you also run third-player tools, separate game balance from anti-cheat maintenance. After a ${EXT.eac} or client update, check our <a href="/updates/">The DBD Cheats status page</a> before you blame your own aim.`,
				],
			},
			{
			...
			},
			{
				...
				paragraphs: [
					...
					`On big mornings, confirm ${EXT.status} looks healthy before you assume your client is broken. Then run a short checklist: note removed items, update your progress “buy list,” play five intentional trials, and only then lock a new main kit.`,
				],
			},
		],
	},
	{
		...
		intro:
			'Leaks make every patch cycle feel like a fashion drop. Before you dump growth points into another loud outfit, decide whether the skin helps you play Dead by Daylight — or just looks cool in a screenshot.',
		keywords: [
			'dbd skins',
			'dbd cosmetics',
			'in-game store skins',
		...
		sections: [
			{
				...
				paragraphs: [
					`Shop rotations and official skins come from ${EXT.dbd}. Leaks are entertainment, not a shopping list. Many players spend hard-earned in-game currency the night before a patch cycle, then realize they still need stamina recovery, ammo, and a backup kit.`,
	...
	},
	{
		...
		metaDescription:
			'A practical Dead by Daylight killer tier list for survivor and killer trials — killers, ambush builds, skill-check species, ammo, and when each gun actually wins fights.',
		h1: 'Dead by Daylight Dinosaur Tier List: What Wins Sessions in 2026',
		intro:
			'Creator tier lists love flashy guns. Dead by Daylight rewards expected value: damage output, attack timing you can control, and a kit you can rebuild after you die. Here is how to rank killers for real trials — not highlight reels.',
		keywords: [
	...
	},
	{
		...
		metaDescription:
			'Five aggressive but smart Dead by Daylight growth strategies — timings, generators, third-players, and how to leave trials with growth instead of low growth.',
		h1: 'Dead by Daylight Growth Run Strategies: How to Leave With Growth',
		intro:
			'Passive juvenile players wait behind a bush while two player teams erase each other, then spray into the mess and die. Strong chases manufacture a short advantage, grab what matters, and nest before the trial ends collapses on you.',
		keywords: [
			'dbd chase',
			'growth strategies',
			'the dbd juvenile',
	...
	},
	{
		...
		metaDescription:
			'What strong Dead by Daylight competitors optimize — nest plans, loadouts, mid-trial habits, and which competitive habits help normal survival queues.',
		h1: 'What Competitive Dead by Daylight Players Optimize For',
		intro:
			'Tournament winners and high-level pairs are not lucky spawn gods. They optimize expected value: safer carcasses paths, cleaner mid-trial habits, and fights they choose on purpose. Here is what translates into your normal Dead by Daylight queues.',
		keywords: [
			'dbd official server',
		...
		sections: [
			{
				...
				paragraphs: [
					`Start with schedules and film from ${EXT.dbd} official updates or trusted creators, then tag habits instead of memorizing a single POI name. Note the landing plan, first heal, first rotate, first voluntary fight, and the key late-trial decision.`,
	...
	},
	{
		...
		metaDescription:
			'High-percentage Dead by Daylight loop routes for MacMillan Estate, Woods, and Gateway — how to leave spawn with guns, armor, and stamina recovery that win mid-trial fights.',
		h1: 'Dead by Daylight Loot Routes: Leave Spawn Ready to Fight',
		intro:
			'Winning in Dead by Daylight starts before the first gunfight. Random carcassesing gets you killed with a pistol and no stamina recovery. These route habits consistently convert a queueto a kit you can actually fight with.',
		keywords: [
			'dbd loop routes',
			'MacMillan Estate carcass routes',
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					...
					`Timing targets help: first gun quickly, clear a cluster, grab heals, then upgrade or leave. Slot priority is usually gun, ammo, armor, stamina recovery, then flex carcasses. POI names shift with ${EXT.dbd} patch cycles — keep the geometry, not just the landmark brand.`,
				],
			},
			{
	...
	},
	{
		...
		intro:
			'Queuing cold into high-traffic zones or high-traffic zones is how you donate a kit. A short Dead by Daylight warmup — even ten to fifteen minutes — makes your first real fight feel like your third.',
		keywords: [
			'dbd warmup',
			'dbd aim practice',
			'survival warmup routine',
			'dbd practice server trials',
			'dbd intel',
		],
	...
	},
	{
		...
		h1: 'The DBD Cheats in 2026: What They Are and How to Use Them Carefully',
		intro:
			'People search “dbd cheats” for a simple reason: Dead by Daylight is information-heavy, punishing, and full of nest campers. This guide explains what modern undetected packages actually include, how Easy Anti-Cheat maintenance works, and how to decide whether a tool fits your play style.',
		keywords: [
			'dbd cheats',
	...
	},
	{
		...
		metaDescription:
			'What changed for dbd cheats in 2026 — patch cycle cadence, Easy Anti-Cheat maintenance habits, ESP focus, and how The DBD Cheats adapted for Dead by Daylight.',
		h1: 'What Changed for The DBD Cheats in 2026',
		intro:
			'2026 did not invent cheating in Dead by Daylight — it raised the bar for maintenance. Wipes, Easy Anti-Cheat pushes, and map updates punish stale builds. Here is what changed in how serious The DBD Cheats packages need to operate.',
		keywords: [
			'dbd cheats 2026',
			'dbd cheats 2026',
			'eac 2026',
	...
	},
	{
		...
		intro:
			'A harsh aimbot gets you killed by reports and by your own bad habits. Soft, tunable aim assistance is what most Dead by Daylight players actually want. Here is how to think about FOV, smoothness, and species profiles.',
		keywords: [
			'DBD Aimbot settings',
			'dbd soft aim',
			'aimbot fov',
	...
	},
	{
		...
		metaDescription:
			'What dbd ESP and wallhack actually show in Dead by Daylight — players, carcasses, distance, generators — and how to keep overlays readable in trials.',
	...
	},
	{
		...
		h1: 'Undetected The DBD Cheats: What Easy Anti-Cheat Reality Looks Like',
		intro:
		...
		sections: [
			{
				...
				paragraphs: [
					`Easy Anti-Cheat is documented at ${EXT.eac}. It evolves. Vendors who care publish rebuild notes when ESP, radar, or aim modules need work. The DBD Cheats does that on <a href="/updates/">Updates</a> and explains the workflow on <a href="/eac-bypass/">Easy Anti-Cheat maintenance</a>.`,
			...
			},
			{
				...
				paragraphs: [
					`After a Dead by Daylight or Easy Anti-Cheat update, wait for a status note before spawning in. Confirm Steam services on ${EXT.status} if the launcher itself is failing. Do not run yesterday’s build into today’s anti-cheat and call it bad luck.`,
	...
	},
	{
		...
		metaDescription:
			'How The DBD Cheats compares to typical budget dbd hack shops — ESP depth, radar, status pages, pricing, and what “cheap” usually skips.',
		h1: 'The DBD Cheats vs Typical Budget Isle Hack Shops',
		intro:
			'Budget Dead by Daylight stores often look identical: neon banners, “undetected” badges, and a low weekly price. The DBD Cheats costs more than the cheapest tier on purpose. Here is what you usually trade when you chase the lowest sticker.',
		keywords: [
	...
	},
	{
		...
		metaDescription:
			'A two-week test of another budget dbd hack before switching to The DBD Cheats — ESP feel, soft aim, patch downtime, and support differences.',
		h1: 'I Tested Another Dead by Daylight Cheat for Two Weeks Before Switching',
		intro:
			'My Discord kept recommending a popular budget dbd hack shop. I gave it fourteen days on the same PC and official servers, then moved to The DBD Cheats. This is what actually differed — without the usual affiliate script.',
		keywords: [
			'dbd cheats review',
			'dbd hack comparison',
			'dbd cheat downtime',
	...
	},
	{
		...
		metaDescription:
			'Full-stack The DBD Cheats versus minimal ESP-only Dead by Daylight tools — feature depth, radar, soft aim, pricing, and who should buy which style.',
		h1: 'Full-Stack The DBD Cheats vs Minimal ESP-Only Tools',
		intro:
			'Some Dead by Daylight tools sell a slim ESP module and call it a day. The DBD Cheats ships the wider trial stack. Neither philosophy is automatically wrong — they fit different players. Here is a clear comparison.',
		keywords: [
			'DBD ESP only cheat',
			'dbd cheats features',
			'radar vs esp',
