...
export const galleryUi: Record<LocaleCode, GalleryUi> = {
	en: {
		...
		lead: 'DBD Cheats helps you spot survivors, killers, generators, and generators with ESP, aimbot, and radar in one license.',
		highlights: [
	...
	es: {
		...
		lead: 'DBD Cheats está pensado para el loop BR de Dead by Daylight: leer el mapa, rastrear escuadrones enemigos, generatorsear y sobrevivir al extract.',
		highlights: [
			...
			{ title: 'Marcadores de generators y cofres', copy: 'Resalta loadouts, cofres y generators de alto nivel sin saturar la pantalla en plena partida.' },
	...
	fr: {
		...
		lead: 'DBD Cheats suit la boucle BR de Dead by Daylight : lire la carte, suivre les escouades, generators et survivre au extract.',
		highlights: [
			{ title: 'ESP players & escouades', copy: 'Repérez les players ennemis sur MacMillan Estate et chase pour choisir vos engagements.' },
			{ title: 'Marqueurs generators & coffres', copy: 'Mettez en évidence loadouts, coffres et generators haut niveau sans encombrer l\'écran.' },
	...
	de: {
		...
		lead: 'DBD Cheats passt zur Raid-Schleife von Dead by Daylight: Karte lesen, Gegner-Trupps tracken, jagen und Nester überleben.',
		highlights: [
	...
	pt: {
		...
		lead: 'DBD Cheats segue o loop BR do Dead by Daylight: ler o mapa, rastrear epackrões, generatorsar e sobreviver ao extract.',
		highlights: [
			...
			{ title: 'Marcadores de generators e cofres', copy: 'Destaque loadouts, cofres e generators de alto nível sem poluir a tela.' },
	...
	it: {
		...
		lead: 'DBD Cheats è pensato per il loop BR di Dead by Daylight: leggere la mappa, tracciare teamre nemiche, generators e sopravvivere al extract.',
		highlights: [
			{ title: 'ESP playeri e teamre', copy: 'Individua playeri nemici su MacMillan Estate e chase per scegliere i fight con più intel.' },
			{ title: 'Marker generators e coffreti', copy: 'Evidenzia loadout, coffreti e generators di alto livello senza riempire lo schermo.' },
	...
	nl: {
		...
		lead: 'DBD Cheats volgt de trial-loop va Dead by Daylight: kaart lezen, vijandelijke teams volgen, jagen en hook zones overleven.',
		highlights: [
			{ title: 'Player- & team-ESP', copy: 'Spot vijandelijke players op MacMillan Estate en chase voor betere rotatiebeslissingen.' },
			{ title: 'Loot- & chestmarkers', copy: 'Markeer loadout-drops, chesten en high-tier generators zonder schermoverlast.' },
	...
	pl: {
		...
		lead: 'DBD Cheats pasuje do pętli BR Dead by Daylight: czytaj mapę, śledź wrogie drużyny, generatorsuj i przeżyj extract.',
		highlights: [
			{ title: 'ESP players i drużyn', copy: 'Wykrywaj wrogich players na MacMillan Estate i chase dla lepszych decyzji rotacyjnych.' },
			{ title: 'Markery generatorsu i skrzyń', copy: 'Podświetlaj loadouty, petity i wysokiej klasy generators bez zaśmiecania ekranu.' },
	...
	ru: {
		...
		lead: 'DBD Cheats создан для рейд-циклу Dead by Daylight: читать карту, отслеживать вражеские отряды, лут и выживать в extract.',
		highlights: [
	...
	tr: {
		...
		lead: 'DBD Cheats, Dead by Daylight BR döngüsü için: haritayı oku, düşman takımları izle, generators al ve extract\'da hayatta kal.',
		highlights: [
			{ title: 'Player ve takım ESP', copy: 'MacMillan Estate ve chase\'da düşman playerleri görerek daha iyi rotasyon kararları alın.' },
			{ title: 'Loot ve kontrat işaretleri', copy: 'Loadout, kontrat ve üst seviye generators\'u ekranı doldurmadan vurgulayın.' },
	...
	ar: {
		...
		lead: 'DBD Cheats مبني لحلقة BR في Dead by Daylight: قراءة الخريطة، تتبع الفرق، جمع اللوت والنجاة في extract.',
		highlights: [
	...
	ja: {
		...
		lead: 'DBD CheatsはDead by DaylightのBRループ向け：マップを読み、敵スクワッドを追跡し、ルートしてextractを生き延びる。',
		highlights: [
	...
	ko: {
		...
		lead: 'DBD Cheats는 Dead by Daylight trial loop용: 맵 읽기, 적 스쿼드 추적, 루트 수집, extract 생존.',
		highlights: [
	...
	zh: {
		...
		lead: 'DBD Cheats 为 Dead by Daylight trial loop设计：读图、追踪敌方小队、搜刮并在 generator survival。',
		highlights: [
	...
	hi: {
		...
		subtitle: 'Loadout, team chases और trial visuals — ESP, radar और Aimbot के साथ।',
		lead: 'DBD Cheats Dead by Daylight trial loop के लिए: map पढ़ें, enemy teams track करें, generators करें और generator survival करें।',
		highlights: [
			{ title: 'Player & Squad ESP', copy: 'MacMillan Estate और chase पर enemy players spot करें बेहतर rotation decisions के लिए।' },
			{ title: 'Loot & Chest Markers', copy: 'Loadout drops, chests और high-tier generators highlight करें screen clutter के बिना।' },
	...
	id: {
		...
		lead: 'DBD Cheats untuk loop BR Dead by Daylight: baca peta, lacak team musuh, generators, dan selamat di extract.',
		highlights: [
			{ title: 'ESP player & team', copy: 'Deteksi player musuh di MacMillan Estate dan chase untuk keputusan rotasi lebih baik.' },
			{ title: 'Marker generators & peti', copy: 'Sorot loadout, peti, dan generators tier tinggi tanpa membanjiri layar.' },
	...
	th: {
		...
		lead: 'DBD Cheats สำหรับลูป BR ของ Dead by Daylight: อ่านแผนที่ ติดตามทีมศัตรู เก็บ generators และรอด extract',
		highlights: [
			{ title: 'ESP ผู้เล่นและทีม', copy: 'มองเห็นศัตรูบน MacMillan Estate และ chase เพื่อตัดสินใจหมุนเวียนได้ดีขึ้น' },
			{ title: 'มาร์กเกอร์ generators และหีบ', copy: 'เน้น loadout หีบและ generators ระดับสูงโดยไม่รกหน้าจอ' },
	...
	vi: {
		...
		lead: 'DBD Cheats cho vòng BR Dead by Daylight: đọc bản đồ, theo dõi team địch, generators và sống sót extract.',
		highlights: [
			{ title: 'ESP player & team', copy: 'Phát hiện player địch trên MacMillan Estate và chase để quyết định rotate tốt hơn.' },
			{ title: 'Đánh dấu generators & rương', copy: 'Làm nổi bật loadout, rương và generators cao cấp mà không che màn hình.' },
	...
	uk: {
		...
		lead: 'DBD Cheats для рейд-циклу Dead by Daylight: читати карту, відстежувати ворожі загони, лут і виживати в extract.',
		highlights: [
	...
	cs: {
		...
		lead: 'DBD Cheats pro BR smyčku Dead by Daylight: číst mapu, sledovat nepřátelské teamy, generators a přežít extract.',
		highlights: [
			{ title: 'ESP players a teamů', copy: 'Spozorujte nepřátelské operátory na MacMillan Estate a chase pro lepší rotační rozhodnutí.' },
			{ title: 'Markery generatorsu a petitů', copy: 'Zvýrazněte loadouty, petity a high-tier generators bez přeplnění obrazovky.' },
	...
	ro: {
		...
		lead: 'DBD Cheats pentru bucla BR Dead by Daylight: citește harta, urmărește team-uri inamice, generators și supraviețuiește extract.',
		highlights: [
			{ title: 'ESP playeri și team-uri', copy: 'Detectează playeri inamici pe MacMillan Estate și chase pentru decizii de rotație mai bune.' },
			{ title: 'Markere generators și cheste', copy: 'Evidențiază loadout-uri, cheste și generators de nivel înalt fără a aglomera ecranul.' },
	...
	sv: {
		...
		lead: 'DBD Cheats för Dead by Daylight:s trial-loop: läs kartan, spåra fiendepacks, generatorsa och överlev extract.',
		highlights: [
			{ title: 'Player- & team-ESP', copy: 'Spotta fiendeplayerer på MacMillan Estate och chase för bättre rotationsbeslut.' },
			{ title: 'Loot- & petitsmarkörer', copy: 'Markera loadout-drops, petit och high-tier generators utan skärmklutter.' },
