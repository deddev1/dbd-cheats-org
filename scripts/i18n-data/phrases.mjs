...
export const phrases = {
	es: {
		buy: 'Comprar DBD Cheats', undetected: 'indetectables', maps: 'MacMillan Estate, Autohaven, and Coldwind Farm',
	...
	fr: {
		buy: 'Acheter DBD Cheats', undetected: 'indétectables', maps: 'MacMillan Estate, Autohaven, and Coldwind Farm',
	...
	de: {
		buy: 'DBD Cheats kaufen', undetected: 'undetected', maps: 'MacMillan Estate, Autohaven, and Coldwind Farm',
	...
	pt: {
		buy: 'Comprar DBD Cheats', undetected: 'indetectáveis', maps: 'MacMillan Estate, Autohaven, and Coldwind Farm',
	...
	it: {
		buy: 'Acquista DBD Cheats', undetected: 'indetectable', maps: 'MacMillan Estate, Autohaven, and Coldwind Farm',
	...
	nl: {
		buy: 'DBD Cheats kopen', undetected: 'undetected', maps: 'MacMillan Estate, Autohaven, and Coldwind Farm',
	...
	pl: {
		buy: 'Kup DBD Cheats', undetected: 'undetected', maps: 'MacMillan Estate, Autohaven, and Coldwind Farm',
	...
	ru: {
		buy: 'Купить DBD Cheats', undetected: 'undetected', maps: 'MacMillan Estate, Autohaven, and Coldwind Farm',
	...
	tr: {
		buy: 'DBD Cheats satın al', undetected: 'undetected', maps: 'MacMillan Estate, Autohaven, and Coldwind Farm',
	...
	ar: {
		buy: 'اشترِ DBD Cheats', undetected: 'غير مكتشف', maps: 'MacMillan Estate, Autohaven, and Coldwind Farm',
	...
	ja: {
		buy: 'DBD Cheatsを購入', undetected: 'undetected', maps: 'MacMillan Estate, Autohaven, and Coldwind Farm',
	...
	ko: {
		buy: 'DBD Cheats 구매', undetected: 'undetected', maps: 'MacMillan Estate, Autohaven, and Coldwind Farm',
	...
	zh: {
		buy: '购买 DBD Cheats', undetected: 'undetected', maps: 'MacMillan Estate, Autohaven, and Coldwind Farm',
	...
	hi: {
		buy: 'DBD Cheats खरीदें', undetected: 'undetected', maps: 'MacMillan Estate, Autohaven, and Coldwind Farm',
	...
	id: {
		buy: 'Beli DBD Cheats', undetected: 'undetected', maps: 'MacMillan Estate, Autohaven, and Coldwind Farm',
	...
	th: {
		buy: 'ซื้อ DBD Cheats', undetected: 'undetected', maps: 'MacMillan Estate, Autohaven, and Coldwind Farm',
	...
	vi: {
		buy: 'Mua DBD Cheats', undetected: 'undetected', maps: 'MacMillan Estate, Autohaven, and Coldwind Farm',
	...
	uk: {
		buy: 'Купити DBD Cheats', undetected: 'undetected', maps: 'MacMillan Estate, Autohaven, and Coldwind Farm',
	...
	cs: {
		buy: 'Koupit DBD Cheats', undetected: 'undetected', maps: 'MacMillan Estate, Autohaven, and Coldwind Farm',
	...
	ro: {
		buy: 'Cumpără DBD Cheats', undetected: 'undetected', maps: 'MacMillan Estate, Autohaven, and Coldwind Farm',
	...
	sv: {
		buy: 'Köp DBD Cheats', undetected: 'undetected', maps: 'MacMillan Estate, Autohaven, and Coldwind Farm',
