...
const ENGLISH_PATHS = [
	...
	'/reviews/dbd-generator-esp-review-lootgoblinx/',
	'/reviews/dbd-soft-aim-trial-review-rankedgrind42/',
	'/reviews/dbd-radar-hack-review-vanlifedbd/',
	'/reviews/dbd-eac-update-review-patchdaymike/',
	'/reviews/dbd-skill-check-soft-aim-review-snipezonly/',
	'/faq/what-are-dbd-cheats/',
	'/faq/are-dbd-cheats-undetected-in-2026/',
	'/faq/survivor-and-killer-trials/',
