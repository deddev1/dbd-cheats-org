...
const REPLACEMENTS = [
	...
	['ricochet', 'eac'],
	['trial map, Urzikstan, and Rebirth Island', 'trial map, Zero Build, and live servers'],
	['trial map, Urzikstan and Rebirth Island', 'trial map, Zero Build and live servers'],
	['trial map, Urzikstan, et Rebirth Island', 'trial map, Zero Build et lobbies compétitifs'],
	['trial map, Urzikstan e Rebirth Island', 'trial map, Zero Build e lobbies competitivi'],
	['trial map, Urzikstan und Rebirth Island', 'trial map, Zero Build und Competitive-Lobbys'],
	...
	['fresh generators', 'loot chests'],
	['loadout drop', 'loot chest'],
	['contracts', 'chests'],
	['contract', 'chest'],
	['Al Mazrah', 'trial map'],
	['al-mazrah', 'survival-game-island'],
