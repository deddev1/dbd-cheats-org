...
export const enPages = {
	...
	'dbd-aimbot': {
		...
		sections: [
			section(
				...
				`Killer balance and season rules change via ${EXT.dbd}. Revisit Aimbot FOV and smoothness after major combat patches so assist still matches the live chase pressure windows.`,
			),
			section(
	...
	features: {
		...
		sections: [
			section(
				...
				`Map and generator systems evolve with ${EXT.dbd} patch cycle and map updates — toggleable ESP categories keep overlays useful when tiles rotate.`,
			),
			section(
	...
	pricing: {
		...
		sections: [
			section(
				'Monthly and lifetime DBD Cheats plans',
	...
	setup: {
		...
		sections: [
			...
			section(
				...
				`Official anti-cheat background: ${EXT.eac}. Our practical workflow is documented on the <a href="/updates/">Easy Anti-Cheat bypass page</a> and <a href="/dead-by-daylight-cheats/">undetected guide</a>.`,
	...
	updates: {
		...
		sections: [
			section(
				...
				`Use ${EXT.status} for Behaviour Interactive platform health and this page for DBD Cheats build status — both matter on big update days.`,
	...
	faq: {
		...
		sections: [
			section(
				...
				`Dead by Daylight itself is published by Behaviour Interactive (${EXT.dbd}). Cheats are third-party tools and may violate Behaviour Interactive' rules — use is at your own risk.`,
			),
			section(
				'Are DBD Cheats undetected in 2026?',
	...
	undetected: {
		...
		sections: [
			section(
				'What undetected means for DBD Cheats',
				...
				`Anti-cheat technology is documented by ${EXT.eac}; Dead by Daylight client updates ship through ${EXT.dbd}. Undetected status is an ongoing process tied to those releases.`,
			),
			section(
	...
	wallhack: {
		...
		intro:
			'dbd wallhack ESP for Dead by Daylight — see players, generators, killers, and hook locations through toggleable wallhack overlays built for survivor and killer trials.',
		...
		sections: [
			...
			section(
				...
				`Season maps and tile changes are announced via ${EXT.dbd}. Wallhack remains useful because it tracks entities, not fixed landmarks alone.`,
	...
	radar: {
		...
		description:
			'dbd radar hack for flank awareness on Windows PC. Bundled with ESP boxes, soft aim, and radar in our DBD Cheats package.',
	...
	'eac': {
		title: 'Easy Anti-Cheat Bypass Dead by Daylight | DBD Cheats Maintenance',
		description:
			'How dbd cheats rebuild after Easy Anti-Cheat patches — ESP boxes, soft aim, and radar maintenance for Windows PC. Read before queueing.',
		h1: 'Easy Anti-Cheat Bypass — DBD Cheats Maintenance',
		intro:
			'Understand Easy Anti-Cheat maintenance for DBD Cheats — how ESP wallhack, radar hack, and Aimbot rebuild after Dead by Daylight security updates.',
		...
		sections: [
			section(
				...
				`DBD Cheats monitors Easy Anti-Cheat patch notes and Dead by Daylight seasonal updates from ${EXT.dbd} to schedule module reviews.`,
	...
	'cheats-2026': {
		...
		sections: [
			section(
				'Why dbd cheats buyers choose DBD Cheats in 2026',
	...
	hacks: {
		...
		sections: [
			...
			section(
				...
				`See ${EXT.eac} for anti-cheat background and our <a href="/updates/">Easy Anti-Cheat bypass guide</a> for the practical workflow. Pair with <a href="/dead-by-daylight-cheats/">undetected dbd cheats</a> for status language buyers expect.`,
	...
	'mod-menu': {
		...
		description:
			'Dead by Daylight mod menu for in-match toggles — ESP boxes, soft aim, radar, and on Windows PC. Undetected DBD Cheats package.',
	...
	'soft-aim': {
		...
		sections: [
			...
			section(
				...
				`Weapon chase pressures shift with ${EXT.dbd} balance patches — retune smoothness after major combat updates.`,
	...
	'esp-hack': {
		...
		sections: [
			...
			section(
				...
				`tile and generator changes publish through ${EXT.dbd} — keep categories toggled to what the current map rewards.`,
			),
			section(
	...
	'unlock-all': {
		...
		intro:
			'Dead by Daylight unlock-all is a common search term for Dead by Daylight — this page clarifies what unlock-all tools claim versus the ESP wallhack, radar hack, and Aimbot tools DBD Cheats actually provides on Windows PC.',
		...
		sections: [
			...
			section(
				'Buying DBD Cheats for the right reasons',
	...
	privacy: {
		...
		description:
			'Privacy policy for DBD Cheats. How we handle support emails, order data, and checkout for dbd cheats licenses on dbdcheats.org.',
		h1: 'Privacy Policy',
	...
	refund: {
		...
		description:
			'Refund policy for DBD Cheats. Digital delivery terms and eligibility for DBD Cheats packages with ESP, soft aim, and radar.',
		h1: 'Refund Policy',
		intro:
			'Refund terms for DBD Cheats licenses — ESP wallhack, radar hack, and Aimbot packages purchased through checkout for Dead by Daylight.',
	...
	terms: {
		...
		description:
			'Terms of use for dbdcheats.org and DBD Cheats licenses. Usage rules, anti-cheat risk, and liability for Windows PC cheats.',
		h1: 'Terms of Use',
