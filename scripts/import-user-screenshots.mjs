...
const REMOVE_PREFIXES = [
	'dbd-survival-game-combat',
	'dbd-extract-fight',
	'dbd-cheats-aimbot',
	'dead-by-daylight-cheats-cover',
	'dbd-cheats-esp-wallhack',
	'dbd-cheats-hero',
	'dbd-cheats-logo',
	'dead-by-daylight-cheats-package',
	'dbd-header-art',
	'dbd-loadout-builder',
	'dbd-player-esp',
...
async function removeOldDead by DaylightImages() {
...
await removeOldDead by DaylightImages();
