		...
		en: {
			...
			pages: {
				home: {
					...
					intro: "DBD Cheats is the undetected DBD Cheats package for Windows PC — built for Dead by Daylight on Windows PC. DBD ESP wallhack, 2D radar, and DBD Aimbot with Easy Anti-Cheat maintenance after every major patch.",
