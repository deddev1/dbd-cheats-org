#!/usr/bin/env node
/**
 * Ports the 8 posts from ../isle-blog into src/data/blog/posts.generated.ts
...
const file = `/* Auto-generated by scripts/port-from-isle-blog.mjs — do not edit by hand. */
