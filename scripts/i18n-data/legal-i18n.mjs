...
export const LEGAL_I18N = {
	es: {
		...
		descFor: 'para DBD Cheats — ESP wallhack, Aimbot',
		privacy: {
	...
	fr: {
		...
		descFor: 'pour DBD Cheats — ESP wallhack, Aimbot',
		privacy: {
	...
	de: {
		...
		descFor: 'für DBD Cheats — ESP wallhack, Aimbot',
		privacy: {
	...
	it: {
		...
		descFor: 'per DBD Cheats — ESP wallhack, Aimbot',
		privacy: {
	...
	nl: {
		...
		descFor: 'voor DBD Cheats — ESP wallhack, Aimbot',
		privacy: {
	...
	pl: {
		...
		descFor: 'dla DBD Cheats — ESP wallhack, Aimbot',
		privacy: {
	...
	ru: {
		...
		descFor: 'для DBD Cheats — ESP wallhack, Aimbot',
		privacy: {
	...
	tr: {
		...
		descFor: 'DBD Cheats — ESP wallhack, Aimbot için',
		privacy: {
	...
	ar: {
		...
		descFor: 'لـ DBD Cheats — ESP wallhack, Aimbot',
		privacy: {
	...
	ja: {
		...
		descFor: 'DBD Cheats — ESP wallhack、Aimbot向け',
		privacy: {
	...
	ko: {
		...
		descFor: 'DBD Cheats — ESP wallhack, Aimbot용',
		privacy: {
	...
	zh: {
		...
		descFor: 'DBD Cheats — ESP wallhack、Aimbot',
		privacy: {
	...
	hi: {
		...
		descFor: 'DBD Cheats — ESP wallhack, Aimbot के लिए',
		privacy: {
	...
	id: {
		...
		descFor: 'untuk DBD Cheats — ESP wallhack, Aimbot',
		privacy: {
	...
	th: {
		...
		descFor: 'สำหรับ DBD Cheats — ESP wallhack, Aimbot',
		privacy: {
	...
	vi: {
		...
		descFor: 'cho DBD Cheats — ESP wallhack, Aimbot',
		privacy: {
	...
	cs: {
		...
		descFor: 'pro DBD Cheats — ESP wallhack, Aimbot',
		privacy: {
	...
	ro: {
		...
		descFor: 'pentru DBD Cheats — ESP wallhack, Aimbot',
		privacy: {
	...
	sv: {
		...
		descFor: 'för DBD Cheats — ESP wallhack, Aimbot',
		privacy: {
