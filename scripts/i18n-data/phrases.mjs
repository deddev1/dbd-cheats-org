...
export const phrases = {
	es: {
		buy: 'Comprar The DBD Cheats', undetected: 'indetectables', maps: 'MacMillan Estate, Autohaven, and Coldwind Farm',
		...
		legal: () => 'Contacta support@dbdcheats.org para solicitudes legales o de soporte.',
	},
	fr: {
		buy: 'Acheter The DBD Cheats', undetected: 'indétectables', maps: 'MacMillan Estate, Autohaven, and Coldwind Farm',
		...
		legal: () => 'Contactez support@dbdcheats.org pour le support ou les demandes légales.',
	},
	de: {
		buy: 'The DBD Cheats kaufen', undetected: 'undetected', maps: 'MacMillan Estate, Autohaven, and Coldwind Farm',
		...
		legal: () => 'support@dbdcheats.org für Support und rechtliche Anfragen.',
	},
	pt: {
		buy: 'Comprar The DBD Cheats', undetected: 'indetectáveis', maps: 'MacMillan Estate, Autohaven, and Coldwind Farm',
		...
		legal: () => 'Contacte support@dbdcheats.org para suporte ou questões legais.',
	},
	it: {
		buy: 'Acquista The DBD Cheats', undetected: 'indetectable', maps: 'MacMillan Estate, Autohaven, and Coldwind Farm',
		...
		legal: () => 'Contatta support@dbdcheats.org per supporto o richieste legali.',
	},
	nl: {
		buy: 'The DBD Cheats kopen', undetected: 'undetected', maps: 'MacMillan Estate, Autohaven, and Coldwind Farm',
		...
		legal: () => 'support@dbdcheats.org voor support en juridische vragen.',
	},
	pl: {
		buy: 'Kup The DBD Cheats', undetected: 'undetected', maps: 'MacMillan Estate, Autohaven, and Coldwind Farm',
		...
		legal: () => 'support@dbdcheats.org w sprawach wsparcia i prawnych.',
	},
	ru: {
		buy: 'Купить The DBD Cheats', undetected: 'undetected', maps: 'MacMillan Estate, Autohaven, and Coldwind Farm',
		...
		legal: () => 'support@dbdcheats.org для поддержки и юридических вопросов.',
	},
	tr: {
		buy: 'The DBD Cheats satın al', undetected: 'undetected', maps: 'MacMillan Estate, Autohaven, and Coldwind Farm',
		...
		legal: () => 'Destek ve yasal sorular için support@dbdcheats.org.',
	},
	ar: {
		buy: 'اشترِ The DBD Cheats', undetected: 'غير مكتشف', maps: 'MacMillan Estate, Autohaven, and Coldwind Farm',
		...
		legal: () => 'support@dbdcheats.org للدعم والطلبات القانونية.',
	},
	ja: {
		buy: 'The DBD Cheatsを購入', undetected: 'undetected', maps: 'MacMillan Estate, Autohaven, and Coldwind Farm',
		...
		legal: () => 'サポート・法務: support@dbdcheats.org',
	},
	ko: {
		buy: 'The DBD Cheats 구매', undetected: 'undetected', maps: 'MacMillan Estate, Autohaven, and Coldwind Farm',
		...
		legal: () => '지원 및 법무: support@dbdcheats.org',
	},
	zh: {
		buy: '购买 The DBD Cheats', undetected: 'undetected', maps: 'MacMillan Estate, Autohaven, and Coldwind Farm',
		...
		legal: () => '支持与法务：support@dbdcheats.org',
	},
	hi: {
		buy: 'The DBD Cheats खरीदें', undetected: 'undetected', maps: 'MacMillan Estate, Autohaven, and Coldwind Farm',
		...
		legal: () => 'सहायता: support@dbdcheats.org',
	},
	id: {
		buy: 'Beli The DBD Cheats', undetected: 'undetected', maps: 'MacMillan Estate, Autohaven, and Coldwind Farm',
		...
		legal: () => 'support@dbdcheats.org untuk dukungan dan legal.',
	},
	th: {
		buy: 'ซื้อ The DBD Cheats', undetected: 'undetected', maps: 'MacMillan Estate, Autohaven, and Coldwind Farm',
		...
		legal: () => 'support@dbdcheats.org สำหรับการสนับสนุน',
	},
	vi: {
		buy: 'Mua The DBD Cheats', undetected: 'undetected', maps: 'MacMillan Estate, Autohaven, and Coldwind Farm',
		...
		legal: () => 'support@dbdcheats.org cho hỗ trợ và pháp lý.',
	},
	uk: {
		buy: 'Купити The DBD Cheats', undetected: 'undetected', maps: 'MacMillan Estate, Autohaven, and Coldwind Farm',
		...
		legal: () => 'support@dbdcheats.org для підтримки та правових питань.',
	},
	cs: {
		buy: 'Koupit The DBD Cheats', undetected: 'undetected', maps: 'MacMillan Estate, Autohaven, and Coldwind Farm',
		...
		legal: () => 'support@dbdcheats.org pro podporu a právní dotazy.',
	},
	ro: {
		buy: 'Cumpără The DBD Cheats', undetected: 'undetected', maps: 'MacMillan Estate, Autohaven, and Coldwind Farm',
		...
		legal: () => 'support@dbdcheats.org pentru suport și legal.',
	},
	sv: {
		buy: 'Köp The DBD Cheats', undetected: 'undetected', maps: 'MacMillan Estate, Autohaven, and Coldwind Farm',
		...
		s3: () => `Kontrollera Updates dbder ${KW.eac}-patchar. Ingen cheat garanterar permanent undetected status.`,
		legal: () => 'support@dbdcheats.org för support och juridik.',
	},
};
