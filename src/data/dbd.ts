...
export const dbdImages = {
	...
	packFight: dbdScreenshot(5),
	hacksPackage: dbdScreenshot(6),
	headerArt: dbdScreenshot(5),
	survivalCombat: dbdScreenshot(7),
	extractFight: dbdScreenshot(4),
	ambushFight: dbdScreenshot(4),
	growthRunCombat: dbdScreenshot(3),
	growthRunMode: dbdScreenshot(2),
	survivalIsland: dbdScreenshot(2),
